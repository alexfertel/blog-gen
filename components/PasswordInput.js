  ...
  return (
    <div className="mt-4">
      <div className="relative flex items-center w-full h-12 max-w-3xl">
        <input
          ref={registeredRef}
          className="absolute w-full py-2 pl-4 pr-10 leading-6 text-gray-800 placeholder-gray-500 transition-all duration-300 bg-gray-200 border border-gray-200 rounded focus:bg-white focus:border-blue-300 hover:border-blue-300 focus:outline-none"
